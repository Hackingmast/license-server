...
"[project]/src/lib/questionParser.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/ConfigureTest.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$questionStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/questionStore.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionParser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/questionParser.ts [app-ssr] (ecmascript)");
...
;
;
const configSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    timer: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].coerce.number().int().positive({
        message: 'Timer must be a positive number of minutes.'
    }).min(1, {
        message: 'Minimum time is 1 minute.'
    }),
    questionLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].coerce.number().int().positive({
        message: 'Question limit must be a positive number.'
    }).min(1, {
        message: 'Minimum 1 question.'
    }),
    passingPercentage: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].coerce.number().int().min(1, {
        message: 'Passing percentage must be between 1 and 100.'
    }).max(100, {
        message: 'Passing percentage must be between 1 and 100.'
    }),
    questionFile: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].any().refine((val)=>"undefined" === 'undefined' || val instanceof FileList, "Invalid file input")
});
function ConfigureTest() {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const setConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$testConfigStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTestConfigStore"])((state)=>state.setConfig);
    const configStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$testConfigStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTestConfigStore"])((state)=>state.config); // Renamed to avoid conflict
    ...
    const setQuestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$questionStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuestionStore"])((state)=>state.setQuestions);
    const clearQuestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$questionStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuestionStore"])((state)=>state.clearQuestions);
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const unsubscribe = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"].persist.onHydrate(()=>{
            console.log("[ConfigureTest] Zustand hydrated.");
            setIsLoading(false);
            const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"].getState().user;
            if (!currentUser) {
        ...
        const timeoutId = setTimeout(()=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"].persist.hasHydrated()) {
    ...
    const onSubmit = async (data)=>{
        ...
        reader.onload = async (e)=>{
            ...
            try {
                const parsedQuestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionParser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseQuestionsFromFileContent"])(content);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__bcd8efbe._.js.map